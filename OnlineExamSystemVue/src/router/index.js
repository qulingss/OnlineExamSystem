  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/studentManage/:teacherId?', //学生管理界面，支持可选的teacherId参数
        ...
        },
        {
          ...
          component: () => import('@/components/teacher/examVideoMonitor')
        },
        {
          path: '/pageSwitchMonitor',
          component: () => import('@/components/teacher/pageSwitchMonitor')
        }
      ]
    },
    {
      ...
      children: [
        ...
        {path: '/selectCourse', name: 'selectCourse', component: () => import('@/components/student/studentSelectCourse')}
      ]
    },
